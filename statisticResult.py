...
if __name__ == "__main__": 
    ...
    filesNameList = support.getResultFileNameFromFolder('I:\\bibm2016\\experiments\\cds2015\\eval\\final3') 
    resCsv = extractMetricsToString(filesNameList, ['infNDCG', 'iP10'])
    support.saveFile(resCsv, 'I:\\bibm2016\\experiments\\cds2015\\resultStatistic\\final3.csv')
