...
if __name__ == "__main__": 
    ...
    filesNameList = support.getResultFileNameFromFolder('I:\\bibm2016\\experiments\\cds2014\\eval\\final') 
    resCsv = extractMetricsToString(filesNameList, ['infNDCG', 'iP10'])
    support.saveFile(resCsv, 'I:\\bibm2016\\experiments\\cds2014\\resultStatistic\\final.csv')
